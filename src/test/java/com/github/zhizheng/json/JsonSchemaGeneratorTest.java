...
//		jsonSchemaConfig.setPrintExclusiveMinimum(true); // 设置打印 exclusiveMinimum 属性（开关）
//		jsonSchemaConfig.setPrintExclusiveMaximum(true); // 设置打印 exclusiveMaximum 属性（开关）
//		jsonSchemaConfig.setPrintMinLength(true); // 设置打印 minLength 属性（开关）
//		jsonSchemaConfig.setPrintMaxLength(true); // 设置打印 maxLength 属性（开关）
//		jsonSchemaConfig.setPrintMinItems(true); // 设置打印 minItems 属性（开关）
//		jsonSchemaConfig.setPrintUniqueItems(true); // 设置打印 uniqueItems 属性（开关）
//		jsonSchemaConfig.setPrintDefault(true); // 设置打印 default 属性（开关）
//		jsonSchemaConfig.setDefaultFromJson(true); // 设置 default 属性的值从 json 取（开关）
	}
